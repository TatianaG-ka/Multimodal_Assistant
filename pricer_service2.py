# Source: Ed Donner's LLM Engineering course template.
# Kept as reference for the serverless GPU deployment pattern
# (Modal + PEFT LoRA + 4-bit quantization against a pinned HF revision).
# NOT integrated with the active pipeline — SpecialistAgent and FrontierAgent
# call the OpenAI API instead. See README "Origin & Attribution" for full
# context and the list of my modifications across the rest of the project.
